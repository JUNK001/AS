...
public class AppException extends Exception implements UncaughtExceptionHandler {
    ...
    private final static String FOLDER_ERRORLOG ="AS";
    private final static String FILE_ERRORLOG ="ASLog.log";
    /** 定义异常类型 */
   ...
   /*     if (e instanceof HttpException) {
    ...
    private boolean saveToSDCard(Throwable ex) throws Exception {
        ...
        File file = FileUtils.getSaveFile(FOLDER_ERRORLOG, FILE_ERRORLOG);
